...
import { useStyles } from './StyledDiv/OutReach.styles';
    ...
    return (
        <Box className={classes.root}>
            <Grid container sx={{mt : '60px', mb : '30px'}}>
                <Grid item xs={12} sx={{display : 'flex', justifyContent : 'center' ,fontSize : '45px', fontWeight : 'bold'}}>
                    <Box sx={{maxWidth : '940px', textAlign : 'center'}}>
                        Outreach personalization platform trusted by 10,000+ companies worldwide
                    </Box>
                </Grid>
